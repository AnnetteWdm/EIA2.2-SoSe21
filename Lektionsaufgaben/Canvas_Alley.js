...
(function (L08_Canvas_Alley) {
    ...
    function drawTree() {
        ...
        do {
            let y = Math.random() * 350; // Y von 0-350
            let size = 1 - y / 700; //Größe kann max 0,5 werden. -> Wert zw. 0,5 und 1 -> Nach oben hin werden die Büsche kleiner, da y mit in die Größe spielt
...
//# sourceMappingURL=Canvas_Alley.js.map